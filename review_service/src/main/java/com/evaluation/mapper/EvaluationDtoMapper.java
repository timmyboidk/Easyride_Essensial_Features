...
public class EvaluationDtoMapper {
    ...
    public EvaluationDTO toDto(Evaluation evaluation) {
        ...
        if (evaluation.getTagsString() != null && !evaluation.getTagsString().isBlank()) {
            java.util.List<String> tagNames = java.util.Arrays.asList(evaluation.getTagsString().split(","));
