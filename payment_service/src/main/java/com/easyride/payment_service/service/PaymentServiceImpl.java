...
public PaymentResponseDto processPayment(PaymentRequestDto paymentRequestDto) {
    ...
    if (paymentResult) {
        ...
        rocketMQTemplate.convertAndSendOrderly("payment-topic", paymentEvent, payment.getOrderId().toString());
...
public void refundPayment(Long paymentId, Double amount) {
    ...
    if (refundResult) {
        ...
        rocketMQTemplate.convertAndSendOrderly("payment-topic", refundEvent, payment.getOrderId().toString());
    } else {
